...
const Footer = () => {
  return (
    <footer className="site-footer relative bg-black pb-11 pt-40 text-white">
      <div className="absolute inset-0" style={{ background: "radial-gradient(circle at 0% -20%, #a12a91, rgba(33, 13, 123, 0.83), transparent, transparent, transparent)" }}>
      </div>
      <div className="absolute inset-x-0 -top-px">
        <svg className="w-full fill-background" preserveAspectRatio="none" width="1440" height="86" viewBox="0 0 1440 86" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 85.662C240 29.1253 480 0.857 720 0.857C960 0.857 1200 29.1253 1440 85.662V0H0V85.662Z"></path>
        </svg>
      </div>
      <div className="relative">
        <div className="container mb-28">
          <div className="mx-auto w-1/2 text-center max-lg:w-10/12 max-sm:w-full">
            <p className="mb-9 text-[10px] font-semibold uppercase tracking-widest">
              <span className="!me-2 inline-block rounded-xl bg-[#262626] px-3 py-1">
                MagicAI
              </span>
              Pay once, own forever.
            </p>
            <p className="-from-[5%] mb-8 bg-gradient-to-br from-transparent to-white to-50% bg-clip-text font-heading text-[100px] font-bold leading-none tracking-tight text-transparent max-sm:text-[18vw]">
              Start your free trial.
            </p>
            <p className="mb-9 px-10 font-heading text-[20px] font-normal leading-[1.25em] opacity-50">
            ...
            <a className="relative inline-flex items-center overflow-hidden rounded-xl border-[2px] border-white border-opacity-0 bg-white/10 px-7 py-4 font-semibold transition-all duration-300 hover:scale-105 hover:border-white hover:bg-white hover:bg-opacity-100 hover:text-black hover:shadow-lg" href="https://codecanyon.net/item/magicai-openai-content-text-image-chat-code-generator-as-saas/45408109" target="_blank">
              Join our community
              <span className="relative z-10 ms-2 inline-flex items-center">
        ...
        <div className="container">
          <div className="flex flex-wrap items-center justify-between gap-8 pb-7 pt-10 max-sm:justify-center">
            <a href="https://magicai.liquid-themes.com">
              <img src={centralImages.logoWithName} alt="MagicAI logo" />
            </a>
            <ul className="flex flex-wrap items-center gap-7 text-[14px] max-sm:justify-center">
              <li>
                <a className="inline-flex items-center gap-2" href="https://www.instagram.com/">
          ...
          <hr className="border-white border-opacity-15" />
          <div className="flex flex-wrap items-center justify-center gap-4 py-9 max-sm:text-center">
            <p className="!text-end text-[14px] opacity-60">2024 MagicAI. All images are for demo purposes.</p>
          </div>
        </div>
      </div>
    </footer>
